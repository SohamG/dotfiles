...
(custom-set-variables
 ...
 '(org-agenda-files
   '("~/SyncNext/Notes/main.org" "/home/sohamg/Notes/main.org"))
 ...
 '(unicode-fonts-block-font-mapping
   '(("Aegean Numbers"
     ...
     ("Dingbats"
      ("Noto Color Emoji" "Apple Color Emoji" "DejaVu Sans Mono" "Segoe UI Symbol" "Zapf Dingbats" "DejaVu Sans:width=condensed" "Arial Unicode MS" "Code2000" "Noto Sans Symbols" "Symbola" "Quivira" "Everson Mono:weight=bold"))
     ("Domino Tiles"
     ...
     ("Emoticons"
      ("Noto Color Emoji" "Apple Color Emoji" "Segoe UI Symbol" "Symbola" "Quivira"))
